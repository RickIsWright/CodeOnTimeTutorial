...
using Pergh.Handlers;
using Pergh.Web;

namespace Pergh.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        public virtual JObject DefaultSettings
        {
            get
            {
                if (_defaultSettings == null)
                {
                    ...
                    EnsureJsonProperty(_defaultSettings, "appName", "Pergh Task Manager");
        ...
        {
            Pergh.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@Pergh.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@Pergh.com", "ASP.NET", "Code OnTime", true, out status);
